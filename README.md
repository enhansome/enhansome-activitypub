...
* [PeerTube](https://github.com/Chocobozzz/PeerTube) ⭐ 15,309 | 🐛 689 | 🌐 TypeScript | 📅 2026-08-28 - Video streaming platform with ActivityPub and WebTorrent.
* [Lemmy](https://github.com/dessalines/lemmy) ⭐ 14,576 | 🐛 131 | 🌐 Rust | 📅 2026-08-18 - Building a federated alternative to reddit in rust.
* [Misskey](https://github.com/syuilo/misskey) ⭐ 11,311 | 🐛 2,528 | 🌐 TypeScript | 📅 2026-09-04 - Microblogging service based on ActivityPub.
...
* [Bonfire](https://github.com/bonfire-networks/bonfire-app) ⭐ 939 | 🐛 452 | 🌐 Elixir | 📅 2026-09-03 - a federated digital spaces, written in Elixir
...
* [Nextcloud Social](https://github.com/nextcloud/social) ⭐ 498 | 🐛 121 | 🌐 PHP | 📅 2026-09-03 - Federated social network application on Nextcloud.
...
* [Bridgy Fed](https://github.com/snarfed/bridgy-fed) ⭐ 1,231 | 🐛 216 | 🌐 Python | 📅 2026-09-03 - A bridge between IndieWeb and ActivityPub, OStatus.
