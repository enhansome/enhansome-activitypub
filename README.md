...
* [PeerTube](https://github.com/Chocobozzz/PeerTube) ⭐ 15,320 | 🐛 691 | 🌐 TypeScript | 📅 2026-08-28 - Video streaming platform with ActivityPub and WebTorrent.
* [Lemmy](https://github.com/dessalines/lemmy) ⭐ 14,586 | 🐛 132 | 🌐 Rust | 📅 2026-08-18 - Building a federated alternative to reddit in rust.
* [Misskey](https://github.com/syuilo/misskey) ⭐ 11,319 | 🐛 2,529 | 🌐 TypeScript | 📅 2026-09-07 - Microblogging service based on ActivityPub.
...
* [Bonfire](https://github.com/bonfire-networks/bonfire-app) ⭐ 939 | 🐛 451 | 🌐 Elixir | 📅 2026-09-08 - a federated digital spaces, written in Elixir
* [NeoDB](https://github.com/neodb-social/neodb) ⭐ 884 | 🐛 91 | 🌐 Python | 📅 2026-09-07 - an ActivityPub server tracking and review what you read/watch/listen/play.
...
* [Nextcloud Social](https://github.com/nextcloud/social) ⭐ 499 | 🐛 88 | 🌐 PHP | 📅 2026-09-08 - Federated social network application on Nextcloud.
...
* [Bridgy Fed](https://github.com/snarfed/bridgy-fed) ⭐ 1,234 | 🐛 216 | 🌐 Python | 📅 2026-09-08 - A bridge between IndieWeb and ActivityPub, OStatus.
