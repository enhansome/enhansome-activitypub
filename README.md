# Awesome ActivityPub with stars
...
* [PeerTube](https://github.com/Chocobozzz/PeerTube) ⭐ 15,315 | 🐛 689 | 🌐 TypeScript | 📅 2026-09-16 - Video streaming platform with ActivityPub and WebTorrent.
* [Lemmy](https://github.com/dessalines/lemmy) ⭐ 14,599 | 🐛 124 | 🌐 Rust | 📅 2026-09-16 - Building a federated alternative to reddit in rust.
* [Misskey](https://github.com/syuilo/misskey) ⭐ 11,327 | 🐛 2,533 | 🌐 TypeScript | 📅 2026-09-17 - Microblogging service based on ActivityPub.
* [Plume](https://github.com/Plume-org/Plume) ⭐ 2,222 | 🐛 167 | 🌐 Rust | 📅 2025-04-08 - Federated blogging engine with ActivityPub.
...
* [Bonfire](https://github.com/bonfire-networks/bonfire-app) ⭐ 940 | 🐛 459 | 🌐 Elixir | 📅 2026-09-17 - a federated digital spaces, written in Elixir
* [NeoDB](https://github.com/neodb-social/neodb) ⭐ 885 | 🐛 89 | 🌐 Python | 📅 2026-09-16 - an ActivityPub server tracking and review what you read/watch/listen/play.
...
* [Nextcloud Social](https://github.com/nextcloud/social) ⭐ 499 | 🐛 22 | 🌐 PHP | 📅 2026-09-16 - Federated social network application on Nextcloud.
* [Mbin](https://github.com/MbinOrg/mbin) ⭐ 427 | 🐛 138 | 🌐 PHP | 📅 2026-09-15 - A federated content aggregator, content rating, dissussion and microblogging platform
...
* [Social Reader](https://github.com/hyphacoop/reader.distributed.press) ⭐ 20 | 🐛 6 | 🌐 JavaScript | 📅 2024-12-05 - A peer-to-peer, offline ActivityPub client for reading and following microblogs on the Fediverse.
...
* [dariusk/express-activitypub](https://github.com/dariusk/express-activitypub) ⭐ 603 | 🐛 2 | 🌐 JavaScript | 📅 2025-03-03 - A very simple reference implementation of an ActivityPub server using Express.js.
...
* [pylodon](https://github.com/rowanlupton/pylodon) ⭐ 101 | 🐛 8 | 🌐 Python | 📅 2018-08-28 - Flask-based ActivityPub server implementation.
...
* [Bridgy Fed](https://github.com/snarfed/bridgy-fed) ⭐ 1,238 | 🐛 217 | 🌐 Python | 📅 2026-09-17 - A bridge between IndieWeb and ActivityPub, OStatus.
