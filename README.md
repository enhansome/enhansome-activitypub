...
* [PeerTube](https://github.com/Chocobozzz/PeerTube) ⭐ 15,332 | 🐛 694 | 🌐 TypeScript | 📅 2026-09-25 - Video streaming platform with ActivityPub and WebTorrent.
* [Lemmy](https://github.com/dessalines/lemmy) ⭐ 14,611 | 🐛 123 | 🌐 Rust | 📅 2026-09-25 - Building a federated alternative to reddit in rust.
* [Misskey](https://github.com/syuilo/misskey) ⭐ 11,324 | 🐛 2,543 | 🌐 TypeScript | 📅 2026-09-25 - Microblogging service based on ActivityPub.
...
* [Bonfire](https://github.com/bonfire-networks/bonfire-app) ⭐ 943 | 🐛 481 | 🌐 Elixir | 📅 2026-09-25 - a federated digital spaces, written in Elixir
* [NeoDB](https://github.com/neodb-social/neodb) ⭐ 892 | 🐛 90 | 🌐 Python | 📅 2026-09-25 - an ActivityPub server tracking and review what you read/watch/listen/play.
...
* [Nextcloud Social](https://github.com/nextcloud/social) ⭐ 503 | 🐛 7 | 🌐 PHP | 📅 2026-09-25 - Federated social network application on Nextcloud.
...
* [Bridgy Fed](https://github.com/snarfed/bridgy-fed) ⭐ 1,239 | 🐛 214 | 🌐 Python | 📅 2026-09-24 - A bridge between IndieWeb and ActivityPub, OStatus.
